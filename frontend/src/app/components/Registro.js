...
import { registro,reset } from '../../merkmale/autorisierung/authSlice';
    ...
    return (
        ...
        <>
          <section className='heading'>
              ...
              <p align="center">Crear una cuenta</p>
          </section>
          <section className='form'>
              <form onSubmit={onSubmit}>
                <div className='form-group'>
                    <input type='text' className='form-control' id='nombre' name='nombre' value={nombre}
                      placeholder='Introduzca su nombre' onChange={onChange} />
                </div>
                <div className='form-group'>   
                    <input type='email' className='form-control' id='email' name='email'value={email}
                      placeholder='Introduzca su email' onChange={onChange} />
                </div>
                <div className='form-group'>
                    <input type='password' className='form-control' id='password' name='password' value={password}
                        placeholder='Introduzca contraseña' onChange={onChange}/>
                </div>
                <div className='form-group'>
